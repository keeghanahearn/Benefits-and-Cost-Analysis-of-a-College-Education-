...
#regbruh=lm(INCWAGE ~ EDUCATION, data=subset(subsetAgeselect, MULTYEAR==2019 & BACHELORS==1))

#Bachelors Group 2013
#I think this is the correct one
#reguh=lm(INCWAGE ~ BACHELORS + EDUCATION, data=subset(subsetAgeselect, MULTYEAR==2019))
#vs
#reghu=lm(INCWAGE ~ BACHELORS, data=subset(subsetAgeselect, MULTYEAR==2019 & EDUCATION==1))

#stargazer(BD2019,reguh,regbruh,
         # title="Impact of Major on Annual Wages", type="text",
         # df=FALSE, digits=5)
...
##stargazer(reg4,
         # title="Impact of Highschool Diploma on Annual Wages in 2019 plus Marital?", type="text",
         # df=FALSE, digits=5)
#Highschool Group 2017 Regression
#reg5=lm(INCWAGE ~ BACHELORS, data=subset(subsetAgeselect, MULTYEAR==2013 & BUSINESS==1))

#stargazer(reg5,
         # title="Impact of Highschool Diploma on Annual Wages in 2018", type="text",
         # df=FALSE, digits=5)
